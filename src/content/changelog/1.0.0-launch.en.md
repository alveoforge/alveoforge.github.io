...
- Real hexagonal architecture (ports & adapters) with one self-contained vertical slice per entity — domain isolated from database, framework and delivery.
...
- Versioned migrations with your choice of **Flyway or Liquibase** — full parity.
